    ...
    add_meta_box(
        ...
        function ($post) {
            ...
            $fields = [
                ...
                'input_image_url' => 'Input Image URL (Original)', // ✅ Yeni Alan: URL
                'input_attachment_id' => 'Input Attachment ID',     // ✅ Yeni Alan: ID
            ];

            // Prompt için ayrı bir textarea kullanılması daha uygundur.
            $prompt_value = esc_textarea(get_post_meta($post->ID, 'prompt', true)); // esc_textarea kullandık
...
add_action('save_post_ai_result', function ($post_id) {
    ...
    $fields_to_sanitize_text = [
        ...
        'input_image_url',       // ✅ Yeni Alan: URL
        'input_attachment_id'    // ✅ Yeni Alan: ID
    ];
